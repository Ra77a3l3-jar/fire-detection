...
pixi run python -m pip uninstall torch torchvision -y

echo ""
echo "Installing PyTorch with CUDA 12.1..."
pixi run python -m pip install torch torchvision --index-url https://download.pytorch.org/whl/cu121

echo ""
echo "Installing missing dependencies..."
pixi run python -m pip install ultralytics-thop
